...
const Schedule =(props) =>{
  return (
    <Flex flexDir={props.val?'column':'row'} backgroundColor={'#6B3273'}  alignItems={'center'} justifyContent={props.val?'space-evenly':'flex-start'}>
        <Flex width={'100%'} padding={props.val?'10px 15px 10px':'30px 80px'} alignItems={'center'} flexDir={props.val && 'column'} height={props.val && '100%'} justifyContent={props.val && 'space-evenly'}>
